...
rm ./.git/info/exclude && mv ./.gitignore ./.git/info/exclude || mv ./configuration/.gitignore ./.git/info/exclude # deleting .gitignore will make it faster, by preventing node_modules from being processed by tools while deleting files.
